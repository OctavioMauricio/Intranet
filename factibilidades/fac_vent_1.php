...
//	$objGrid-> FormatColumn("id","ID", "40", "50", "2", "93", "right", "text");
	...
	$objGrid -> addCellStyle ("estado", "['estado']=='0 sin solicitar'", "colorrojo");
	$objGrid -> addCellStyle ("estado", "['estado']=='1 solicitado'", "colornegro");
	$objGrid -> addCellStyle ("estado", "['estado']=='2 cotizado cliente'", "colorazul");
	$objGrid -> addCellStyle ("estado", "['estado']=='5 instalacion'", "colorrojo");
	$objGrid -> addCellStyle ("estado", "['estado']=='6 en provision'", "colormagenta");
	$objGrid -> addCellStyle ("estado", "['estado']=='7 en produccion'", "colorverde");
	$objGrid -> addCellStyle ("estado", "['estado']=='9 sin factibilidad'", "colorgris");
