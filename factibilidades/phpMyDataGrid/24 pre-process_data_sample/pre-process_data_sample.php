	...
	<table border="0" id="bg">
	  <tr>
		...
		<h2>Pre-Process Data</h2>
			<div id='descripcion'>
				Este ejemplo enseña manipular la información de la tabla antes de mostrarla en el DataGrid
			</div>
			<div id='description'>
				This sample teach how manipulate the table data prior to display it in the DataGrid
            </div>
			<div id='dg'> 
				...
				<?php include_once("pre-process_data_sample_timestamp_grid.php"); ?>
			</div>
