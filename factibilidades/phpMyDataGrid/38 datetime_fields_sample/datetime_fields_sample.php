...
<body>
	...
	<table border="0" id="bg">
	  <tr>
		<td id="content">
			<h2>DateTime type fields</h2>
			<div id='descripcion'>
				Este ejemplo muestra la forma de usar campos datetime
			</div>
			<div id='description'>
				This sample teach how to use datetime fields
			</div>
			<div id='dg'>
				...
				<?php include_once("datetime_fields_sample_grid.php"); ?>
			</div>
            <strong>NOTE: At this time the datetime type fields does not support datepicker function.<br>
            NOTA: En este momento, los campos datetime no aceptan el uso de la función de calendario emergente.</strong>
