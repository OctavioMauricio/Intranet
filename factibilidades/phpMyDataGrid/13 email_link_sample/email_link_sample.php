...
<body>
	...
	<table border="0" id="bg">
	  <tr>
		<td id="content">
			<h2>Link Sample (e-mail)</h2>
			<div id='descripcion'>
				Este ejemplo enseña a generar enlaces usando valor de campos
			</div>
			<div id='description'>
				This sample teach how to generate links by using field data
			</div>
			<div id='dg'> 
				...
				<?php include_once("email_link_sample_grid.php"); ?>
			</div>
