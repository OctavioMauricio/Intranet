...
<body>
	...
	<table border="0" id="bg">
	  <tr>
		<td id="content">
			<h2>Sample No-Layers Grid</h2>
			<div id='descripcion'>
				Este ejemplo enseña a cambiar la presentación normal de phpMyDataGrid a una presentación sin capas/ventanas
			</div>
			<div id='description'>
				This sample teach how to change the layout of datagrid removing all the layers/windows
			</div>
			<div id='dg'> 
				...
				<?php include_once("nowindow_sample_grid.php"); ?>
			</div>
