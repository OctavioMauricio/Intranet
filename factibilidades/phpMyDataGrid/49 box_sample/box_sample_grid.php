<?php
	...
	$objGrid = new datagrid('base_sample_grid.php','1');
	...
	#es: Adicionar un boton de ayuda a la Barra de botones
	#en: Add a Help button to the toolbar
	$objGrid-> addButton("box_sample/help.png", "doHelp()", "Help");
