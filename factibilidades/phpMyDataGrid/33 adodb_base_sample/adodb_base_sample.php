...
<body>
	...
	<table border="0" id="bg">
	  <tr>
		<td id="content">
			<h2>ADOdb Base Sample</h2>
			<div id='descripcion'>
				Este ejemplo enseña a incluir de manera rápida y fácil un datagrid funcional en sus proyectos usando ADOdb para conectarse a la base de datos
			</div>
			<div id='description'>
				This sample teach how to include a datagrid into your proyects in a very easy way by using ADOdb to connect with the database
			</div>
			<div id='dg'>
				...
				<?php include_once("adodb_base_sample_grid.php"); ?>
			</div>
