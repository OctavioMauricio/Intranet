	...
	<table border="0" id="bg">
	  <tr>
		<td id="content">
			...
			<div id='descripcion'>
				Este ejemplo enseña la forma de pre y post procesar la información de la tabla
			</div>
			<div id='description'>
				This sample teach how pre and post process the table data
			</div>
			<div id='dg'> 
				...
				<?php include_once("customize_data_sample_grid.php"); ?>
			</div>
