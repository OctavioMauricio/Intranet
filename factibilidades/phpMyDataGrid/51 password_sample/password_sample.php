...
<body>
	...
	<table border="0" id="bg">
	  <tr>
		<td id="content">
			<h2>Sample - MD5 Password type Field</h2>
			<div id='descripcion'>
				Este ejemplo enseña a usar campos tipo contraseña con md5
			</div>
			<div id='description'>
				This sample teach how to use md5 password typefield
            </div>
			<div id='dg'>
				...
				<?php include_once("password_sample_grid.php"); ?>
			</div>
