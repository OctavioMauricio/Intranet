...
<body>
	...
	<table border="0" id="bg">
	  <tr>
		<td id="content">
			<h2>highlight_search_sample</h2>
			<div id='descripcion'>
				Este ejemplo muestra una forma de resaltar la palabra buscada en un grid
			</div>
			<div id='description'>
				This example shows a way to highlight the searched words in a grid
			</div>
			<div id='dg'>
				...
				<?php include_once("highlight_search_sample_grid.php"); ?>
			</div>
