...
<body>
	...
	<table border="0" id="bg">
	  <tr>
		<td id="content">
			<h2>GetMyOwnButtons Sample</h2>
			<div id='descripcion'>
				Este ejemplo enseña a situar los botones de Adicionar/Buscar/Exportar fuera del DataGrid
			</div>
			<div id='description'>
				This sample teach how to set the Add/Search/Export buttons outside the DataGrid
			</div>
			<div id='dg'>
				...
				<?php include_once("getMyOwnButtons_sample_grid.php"); ?>
			</div>
