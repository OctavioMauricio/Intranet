...
<body>
	...
	<table border="0" id="bg">
	  <tr>
		<td id="content">
			<h2>Select Field Sample</h2>
			<div id='descripcion'>
				Este ejemplo enseña utilizar el tipo de campo 'select' para obtener datos desde otra tabla
			</div>
			<div id='description'>
			...
			<div id='dg'> 
				...
				<?php include_once("select_field_sample_grid.php"); ?>
			</div>
