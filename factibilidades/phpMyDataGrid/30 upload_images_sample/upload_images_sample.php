...
<?php 
	...
	echo set_DG_Header("js/","css/", " /", "rubi");
?>
</head>
	...
	<table border="0" id="bg">
	  <tr>
		<td id="content">
			<h2>Upload Images</h2>
			<div id='descripcion'>
				Este ejemplo enseña a activar el proceso para cargar imagenes en el servidor
			</div>
			<div id='description'>
				This sample teach how to activate the option to upload images to the server
			</div>
			<div id='dg'> 
				...
				<?php include_once("upload_images_sample_grid.php"); ?>
			</div>
