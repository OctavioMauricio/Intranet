	...
	<table border="0" id="bg">
	  <tr>
		<td id="content">
			<h2>Clone Records</h2>
			<div id='descripcion'>
				Este ejemplo enseña a realizar operaciones con registros
			</div>
			<div id='description'>
				This sample teach how to make operations with records
			</div>
			<div id='dg'>
				...
				<?php include_once("clone_records_sample_grid.php"); ?>
			</div>
