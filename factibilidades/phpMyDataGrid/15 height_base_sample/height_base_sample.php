...
<body>
	...
	<table border="0" id="bg">
	  <tr>
		<td id="content">
			<h2>Define a fixed height for the grid</h2>
			<div id='descripcion'>
				Este ejemplo enseña a definir una altura fija para el grid
			</div>
			<div id='description'>
				This sample teach how to define a fixed height for the datagrid
			</div>
			<div id='dg'> 
				...
				<?php include_once("height_base_sample_grid.php"); ?>
			</div>
