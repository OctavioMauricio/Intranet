<?php
	...
	$arrCondiciones = array(
		"['active']==1" => "<img src='conditional_field_buttons_sample/printer.gif' onclick='goPrint(['emp_id'])' style='cursor:pointer'>",
		"['active']==0" => "&nbsp;",
		);
	...
	$objGrid-> FormatColumn("active","", "5", "30", 0, "20", "center", $arrCondiciones);
	...
	#es: Quitar las flechas de ordenamiento a la columna
	#en: Remove sort arrows from column
