...
function goPrint(id){
	location.href='conditional_field_buttons_sample_print.php?id='+id;
}
</script>
</head>
...
<body>
	...
	<table border="0" id="bg">
	  <tr>
		<td id="content">
			<h2>Conditional button typefield</h2>
			<div id='descripcion'>
				Este ejemplo enseña como mostrar un boton diferente basandose en el valor de un campo
			</div>
			<div id='description'>
	            This example shows how to display different buttons based on the value of a field
			</div>
			<div id='dg'> 
				...
				<?php include_once("conditional_field_buttons_sample_grid.php"); ?>
			</div>
