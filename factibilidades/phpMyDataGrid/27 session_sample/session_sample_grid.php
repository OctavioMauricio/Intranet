<?php
	...
	$objGrid = new datagrid('session_sample_grid.php','1');
	...
	#es: Definir el título del grid
	#en: Define Grid Title
	$objGrid-> tituloGrid("Session stored value: " . $userID);
	...
	$objGrid-> FormatColumn("pub_id","UserID", "4", "10", "0", "105", "left", "text", $userID);
