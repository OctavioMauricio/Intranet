	...
	<table border="0" id="bg">
	  <tr>
		<td id="content">
			<h2>ID Validation</h2>
			<div id='descripcion'>
				Este ejemplo enseña a validar que la ID no exista antes de grabar
			</div>
			<div id='description'>
				This sample teach how to validate ID before saving
			</div>
			<div id='dg'>
				...
				<?php include_once("id_validation_sample_grid.php"); ?>
			</div>
