<?php
	...
	$objGrid = new datagrid('conditional_buttons_sample_grid.php','1');
	...
	#es: Definir la condicion para el boton EDITAR
	#en: Define the condition for EDIT button
	$objGrid-> conditionEdit = "['active']==1";
	...
	#es: Definir la condicion para el boton BORRAR
	#en: Define the condition for DELETE button
	$objGrid-> conditionDelete = "['active']!=1";
