...
<?php 
	...
	echo set_DG_Header("js/","css/", " /", "darkblue");
?>
</head>
	...
	<table border="0" id="bg">
	  <tr>
		<td id="content">
			...
			<div id='descripcion'>
				Este ejemplo enseña a mostrar condicionalmente los botones de edición y borrado
			</div>
			<div id='description'>
				This sample teach how to conditionally display the Edit and Delete Buttons
			</div>
			<div id='dg'> 
				...
				<?php include_once("conditional_buttons_sample_grid.php"); ?>
			</div>
