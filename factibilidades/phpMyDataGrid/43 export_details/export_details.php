	...
	<table border="0" id="bg">
	  <tr>
		<td id="content">
            ...
            <div id='descripcion'>
                Este ejemplo enseña a exportar varios tipos de detalles en una relación Maestro/detalle
            </div>
            <div id='description'>
                This example shows various kinds of exporting details in a master / detail
            </div>
            <div id='dg'> 
                ...
                <?php include_once("export_details_grid.php"); ?>
			</div>
