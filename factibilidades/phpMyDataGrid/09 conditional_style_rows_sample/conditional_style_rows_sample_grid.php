<?php
	...
	$objGrid = new datagrid('conditional_style_rows_sample_grid.php','1');
	...
	$objGrid -> addRowStyle ("['active']==1", "activedata");
	...
	$objGrid -> addRowStyle ("['active']==0", "inactivedata");
	$objGrid -> addRowStyle ("empty(['birth_date']) or ['birth_date']=='0000-00-00'", "miss_date");
