...
<body>
	...
	<table border="0" id="bg">
	  <tr>
		<td id="content">
			<h2>Header and footer in actions (Add/Edit/View)</h2>
			<div id='descripcion'>
				Este ejemplo enseña la forma de mostrar un encabezado y un pie en las acciones de adicionar, editar y ver
			</div>
			<div id='description'>
				This example shows how to display a header and a footer in the actions of add, edit and view
			</div>
			<div id='dg'>
				...
				<?php include_once("header_footer_sample_grid.php"); ?>
			</div>
