<?php
	...
	$objGrid = new datagrid('order_records_sample_grid.php','1');
	...
	#es: Definir el campo por el cual se desea ordenar el grid, en este caso debería ser el mismo campo base para manejar el orden de los registros
	#en: Define the field for which you want to sort the grid, in this case should be the same base field to handle the order of records
	$objGrid -> orderby("consecutivo", "ASC");
	
	#es: Quitar las flechas de ordenamiento de la cabecera de las columnas
	#en: Remove the ordering arrows at the top of the columns 
	$objGrid -> noorderarrows();
	
	#es: Definir el campo en el que se mostrarán las flechas de ordenación, IMPORTANTE!!! Este campo NO DEBE SER el mismo ID de los registros
	#en: Define the field in which arrows will be displayed. IMPORTANT!!! This field should not be the same table ID
