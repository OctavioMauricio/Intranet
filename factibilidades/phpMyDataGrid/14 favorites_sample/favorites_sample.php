...
<body>
	...
	<table border="0" id="bg">
	  <tr>
		<td id="content">
			<h2>Add to Favorites like Gmail</h2>
			<div id='descripcion'>
				Este ejemplo enseña a crear un icono de favoritos que funciona de igual manera a Gmail
			</div>
			<div id='description'>
				This sample teach how replicate the Gmail add to favorites star
			</div>
			<div id='dg'> 
				...
				<?php include_once("favorites_sample_grid.php"); ?>
			</div>
