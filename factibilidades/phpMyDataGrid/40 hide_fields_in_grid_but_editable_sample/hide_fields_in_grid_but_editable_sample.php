...
<body>
	...
	<table border="0" id="bg">
	  <tr>
		<td id="content">
			<h2>Hide fields in grid but Editables</h2>
			<div id='descripcion'>
				Este ejemplo enseña a ocultar registros en el grid y mostrarlos al editar
			</div>
			<div id='description'>
				This sample teach how to hide fields in grid but display them when editing
			</div>
			<div id='dg'>
				...
				<?php include_once("hide_fields_in_grid_but_editable_sample_grid.php"); ?>
			</div>
