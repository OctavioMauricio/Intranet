<?php
	...
	$objGrid = new datagrid('in_templates_sample_grid.php','1');
	...
	#es: Definir que la salida del grid se realizará a una variable
	#en: Define dataGrid output will be stored in a var
	if (isset($returnCode))
		$objGrid -> retcode = true;

	#es: Por ultimo, renderizar el Grid
	#en: Finally, render the grid.
	$dataGridText = $objGrid-> grid();
?>