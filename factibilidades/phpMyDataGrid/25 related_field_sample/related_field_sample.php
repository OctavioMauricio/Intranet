...
<body>
	...
	<table border="0" id="bg">
	  <tr>
		<td id="content">
			<h2>Related Field Sample</h2>
			<div id='descripcion'>
				Este ejemplo enseña utilizar el tipo de campo 'related'
			</div>
			<div id='description'>
				This sample teach how to use the 'related' typefield
			</div>
			<div id='dg'> 
				...
				<?php include_once("related_field_sample_grid.php"); ?>
			</div>
