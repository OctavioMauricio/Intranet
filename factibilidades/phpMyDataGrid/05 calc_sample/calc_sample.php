...
<body>
	...
	<table border="0" id="bg">
	  <tr>
		<td id="content">
			<h2>Calculated Fields and totals</h2>
			<div id='descripcion'>
				Este ejemplo enseña a utilizar fórmulas para realizar cálculos entre columnas y totalización de datos
			</div>
			<div id='description'>
				This sample teach how to use formula and totals
			</div>
			<div id='dg'> 
				...
				<?php include_once("calc_sample_grid.php"); ?>
			</div>
