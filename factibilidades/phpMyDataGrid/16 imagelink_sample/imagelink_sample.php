...
<body>
	...
	<table border="0" id="bg">
	  <tr>
		<td id="content">
			<h2>Create Image links</h2>
			<div id='descripcion'>
				Este ejemplo enseña a crear enlaces usando iconos
			</div>
			<div id='description'>
				This sample teach how to create links using images
			</div>
			<div id='dg'> 
				...
				<?php include_once("imagelink_sample_grid.php"); ?>
			</div>
