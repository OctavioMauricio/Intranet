...
<script type="text/javascript" language="javascript">
	function citas(id, fname, lname, active){
		if (active==0) return;	// if inactive do nothing // si esta inactivo no haga nada.
		if (confirm('View payments for: ' + fname + ' ' + lname))
			location.href='imagelink_sample_newpage.php?id='+id;
	}
</script>
</head>
...
<body>
	...
	<table border="0" id="bg">
	  <tr>
		<td id="content">
			<h2>Create Image Advanced links</h2>
			<div id='descripcion'>
				Este ejemplo enseña a crear enlaces usando iconos - Método Avanzado
			</div>
			<div id='description'>
				This sample teach how to create links using images - Advanced Mode
			</div>
			<div id='dg'> 
				...
				<?php include_once("imagelink_sample_advanced_grid.php"); ?>
			</div>
