...
<body>
	...
	<table border="0" id="bg">
	  <tr>
		<td id="content">
			<h2>Conditional Cell Styling</h2>
			<div id='descripcion'>
				Este ejemplo enseña a dar formato a celdas basándose en una o más condicionantes
			</div>
			<div id='description'>
				This sample teach how to format cells, obtaining the result from one or more conditionals
			</div>
			<div id='dg'> 
				...
				<?php include_once("conditional_style_cell_sample_grid.php"); ?>
			</div>
