...
<body>
	...
	<table border="0" id="bg">
	  <tr>
		<td id="content">
			<h2>Conditional typefield</h2>
			<div id='descripcion'>
				Este ejemplo enseña como mostrar una salida HTML basandose en el valor de un campo
			</div>
			<div id='description'>
				This sample teach how to didplay an HTML value based on a field valule
			</div>
			<div id='dg'> 
				...
				<?php include_once("conditional_field_sample_grid.php"); ?>
			</div>
