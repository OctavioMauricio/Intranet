...
<body>
	...
	<table border="0" id="bg">
	  <tr>
		<td id="content">
			<h2>Intercept processes</h2>
			<div id='descripcion'>
				Este ejemplo enseña la forma de interceptar un llamado AJAX para realizar acciones complementarias
			</div>
			<div id='description'>
				This example shows how to intercept an AJAX call to perform additional actions 
			</div>
			<div id='dg'>
				...
				<?php include_once("intercept_data_sample_II_grid.php"); ?>
			</div>
