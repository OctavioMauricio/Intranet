...
//	$objGrid-> FormatColumn("id","ID", "40", "50", "2", "93", "right", "text");
	...
	$objGrid -> FormatColumn("estado", "Estado",  40, 30, 0, "100", "left", "select:00 sin solicitar:01 solicitado:02 cotizado proveedor:02 cotizado cliente:03 aprobado por cliente:04 solicitar instalacion:05 instalacion:06 en provision:07 en produccion:08 dado de baja:09 sin factibilidad:10 rechazada cliente:11 cliente rechazado:12 trasladado","00 sin solicitar");
	$objGrid -> FormatColumn("rut", "R.U.T.", 150, 150, 0,"180", "left");	
	$objGrid -> FormatColumn("nombre", "Nombre Completo", 150, 150, 0, "350", "left");
	$objGrid -> FormatColumn("direccion", "Direccion", 80, 80, 0,"350", "left");
	$objGrid -> FormatColumn("contacto", "Contacto", 100, 200, 0,"350", "left");	
...
//2.- Una función que evalué el arreglo de fechas obtenido, que contenga los feriados nacionales que correspondan (restando) y que reste los sábados y domingos. 
	...
	function fnext_fac() { // recupera la última fac utilizada y le suma 1
		...
		$conn = new mysqli("localhost", "tnasolut_dstudio", "P3rf3ct0.,", "tnasolut_factibilidades");
		// Checkea conexion
