<?php
	...
	$titulo = "Factibilidades Cotizadas o por Cotizar";
...
//	$objGrid-> FormatColumn("id","ID", "40", "50", "2", "93", "right", "text");
	...
	$objGrid -> FormatColumn("estado", "Estado",  40, 30, 0, "120", "left", "select:0 sin solicitar:1 solicitado:2 cotizado proveedor:2 cotizado cliente:3 aprobado por cliente:4 solicitar instalacion:5 instalacion:6 en provision:7 en produccion:8 dado de baja:9 sin factibilidad:10 rechazada cliente:11 cliente rechazado:12 trasladado","0 sin solicitar");
	$objGrid -> FormatColumn("nombre", "Nombre Completo", 150, 150, 0, "210", "left");
	$objGrid -> FormatColumn("direccion", "Direccion", 80, 80, 0,"240", "left");
	...
	$objGrid -> addRowStyle ("['estado']=='02 cotizado proveedor'", "colorrojo");	
//	$objGrid -> addCellStyle ("estado", "['estado']=='02 cotizado proveedor'", "colorrojo");
	...
	$objGrid -> addCellStyle ("estado", "['estado']=='2 cotizado cliente'", "colornegro");	
	$objGrid -> addCellStyle ("estado", "['estado']=='2 cotizado proveedor'", "colorrojo");
