 ...
 <head>
    ...
    <div class='container'>
      ...
      <table align="center" border="0" id="tblData" name="tblData">
            <tr align="center" style="color: white;background-color: #1F1D3E;">
              ...
              <td colspan="2">
                  <table width="100%" height="100%">
                      <tr height="90">
                          <th align="right" valign="bottom" style="font-size: 20px;">Informe de Servicios Activos por Cliente</th>
                      </tr>
                  </table>
              </td>
            </tr>
            ...
            <form  method="post">
            <select name='Recurrencia[]'  multiple size = 4>
                 <option value = 'ANUAL'>ANUAL</option>
                 <option value = 'BIENAL'>BIENAL</option>
                 <option value = 'EN TRASLADO'>EN TRASLADO</option>
                 <option value = 'MENSUAL'>MENSUAL</option>
                 <option value = 'POSIBLE TRASLADO'>POSIBLE TRASLADO</option>
            </select>
