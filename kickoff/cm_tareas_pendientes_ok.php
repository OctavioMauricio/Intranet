...
//=====================================================
            ...
            {
              $style = "";
              $contenido = "<tr><td colspan='14'>No se encontraron Tareas pendientes.</td></tr>";
            }
            $conn->close(); 
            unset($resultado);
            unset($conn);
			$td = '<td colspan="12" align="left" valign="bottom" class="titulo" >&nbsp;&nbsp;⏳ Tareas Abiertas ASIGNADAS A USTED</td>
