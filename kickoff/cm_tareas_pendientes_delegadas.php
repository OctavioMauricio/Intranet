        <?php
            ...
            if ($resultado && $resultado->num_rows > 0) {  
                ...
                usort($datos, function($a, $b) {
                    ...
                    // Si alguna fecha no es v�lida, la empuja al final
            ...
            unset($resultado);
            unset($conn);
			$td = '<td colspan="12" align="left" valign="bottom" class="titulo" >&nbsp;&nbsp;🕒 Tareas Abiertas DELEGADAS POR USTED</td>
		...
		<div><button style="color: #512554;" onclick="capa('tareas_delegadas')">Tareas Pendientes Delegadas [Muestra/Oculta <?PHP echo $ptr; ?>]</button></div>
		<?PHP if(!$muestra) echo "<script>capa('tareas_delegadas');</script>"; ?>
