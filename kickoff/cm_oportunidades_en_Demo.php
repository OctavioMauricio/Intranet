        <?php
            ...
            unset($resultado);
            unset($conn);
			$td = '<td colspan="9" align="left" valign="bottom" class="titulo" >&nbsp;&nbsp;💼 Oportunidades en DEMO</td>
			<td colspan="1" align="right" valign="bottom" style="font-size: 20px; background-color: #512554;"><a href="'.$url_nueva_oportunidad.'" target="new"><b>+<b></a>&nbsp;&nbsp;&nbsp;</td>
			';

        ?>
        <table id="demo" align="center" width="100%">
		...
		<div><button style="color: #512554; border: none" onclick="capa('demo')">Oportunidades en Demo [Muestra/Oculta <?PHP echo $ptr; ?>]</button></div>
		<?PHP if(!$muestra) echo "<script>capa('demo');</script>"; ?>