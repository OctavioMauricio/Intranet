    ...
    <body bgcolor="#FFFFFF" text="#1F1D3E" link="#E95300" >
        <div class='container'>
            ...
            <table width='100%' id='empTable' border='1' cellpadding='10'>
                <tr>
                    <th width="2%">#</span></th>
                    <th width="3%"><span onclick='sortTable("numero");'>Número</span></th>
                    ...
                    <th width="9%"><span onclick='sortTable("f_creacion");'>Fecha Creación</span></th>
                    ...
                    <th  width="5"  align="right"><span onclick='sortTable("dias");'>Días</span></th>
                </tr>
                <?php 
					$query = 'select 
						op.id					as id,
						...
						case
							...
							when op.sales_stage = "Pre_Instalacion_cliente" then "Pre Instalación"
							when op.sales_stage = "Pre_Instalacion" 	then "Pre Instalación"
						end 					as estado,
						ac.name 				as cuenta,
