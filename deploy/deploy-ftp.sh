...
upload_file() {
  ...
  # Si dirname es "." subir directo a la base
  if [ "$(dirname "$rel")" == "." ]; then
    remote_dir="ftp://${FTP_HOST}${FTP_REMOTE_BASE}/"
  fi
...
if [ -f "$LOCAL_PATH" ]; then
  ...
  echo "============================================"
  echo "  🚀 Deploy FTP — $FILENAME"
  echo "============================================"
  echo "  📁 Local  : $LOCAL_ABS"
  echo "  🌐 Remoto : ftp://${FTP_HOST}${FTP_REMOTE_BASE}/"
...
# --- Directorio ---
  ...
  echo "============================================"
  echo "  🚀 Deploy FTP — $(basename "$LOCAL_ABS")"
  echo "============================================"
  echo "  📁 Local  : $LOCAL_ABS"
