    ...
    document.querySelectorAll("table th").forEach(th => {
        ...
        th.onclick = function () {
            ...
            const rows = Array.from(table.querySelectorAll("tbody tr"))
                .sort((r1, r2) => {
                    const c1 = r1.children[index].innerText.trim();
                    const c2 = r2.children[index].innerText.trim();
                    return asc ? c1.localeCompare(c2, undefined, {numeric:true}) 
                               : c2.localeCompare(c1, undefined, {numeric:true});
                });
