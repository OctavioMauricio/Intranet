...
<?PHP include_once("/meta_data/meta_data.html"); ?>   
  <title>Casos Abiertos iContel Telecomunicaciones</title>
   <style type="text/css">
   	html, body, div {
   		margin:0;
   		padding:0;
        ...
        <tr align="center" style="color: white;background-color: #1F1D3E;">
          ...
          <td>
              <table width="100%" height="100%">
                  <tr>
                      <th align="center" style="font-size: 20px;">Clientes Potenciales de [<?PHP echo $sg_name; ?>]<br><span style="font-size: 12px;">(click sobre los t&iacute;tulos para ordenar)</span></th>
