...
<div id="modulo_cobranza_comercial">
    ...
    <tr>
        <td colspan="11" class="titulo" style="background:#512554; color:white; font-weight:bold; font-size:16px; height:38px;">&nbsp;&nbsp;💰📄 Cobranza Comercial</td>
        <td align="right" style="font-size:20px; background:#512554; color:white;">
            <span id="reloadModulo" style="cursor:not-allowed; opacity:0.4;">🔄</span>&nbsp;&nbsp;&nbsp;
        </td>
    </tr>
    </table>

    <table id="cobranza">
    <tr class="subtitulo" style="background:#512554; color:#C39BD3; font-size:12px;">
        <th>#</th>
        <th>Razón Social</th>
    ...
    <div id="toggleWrapper" style="margin:10px 0; cursor:pointer; font-size:12px; color:#1F1D3E;">
        Cobranza Comercial <span id="toggleTexto">[Ocultar <?= $ptr ?>]</span>
    </div>

    <!-- EVENTOS: Estado y Comentario -->
    <script src="js/cb_cobranza_comercial.js?v=1"></script>

</div>

<<!-- Style css -->
<link rel="stylesheet" href="css/cb_cobranza_comercial.css?v=1">
