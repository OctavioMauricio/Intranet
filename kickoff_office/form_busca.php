	<?PHP // buscador de casos horizontal ?>
		<table align="left" border="0" id="busca_casos"  style="border-style: solid solid solid solid; border-color: dimgrey; font-size: small;">
			...
			<tr>
			  <td  align="center" style="background-color: #1F1D3E;color: white;"><input style="background-color: lightgray" placeholder="Caso Nº" name="numero" type="text" id="numero" size="7" value="" /></td>
			  ...
			  <option value = ''>&nbsp;</option>
				  ...
				  <option value = 'termino_contrato'>Término Contrato</option>
