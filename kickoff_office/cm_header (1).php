			...
			<table width="100%" border="0" >
				...
				<tr style="color: white; background-color: #64C2C8;" >
			 	  <td style="vertical-align: bottom">
					<select style="color: white; font-weight: bold; text-decoration: underline; background-color: #64C2C8; border: none; vertical-align: bottom;" name="formulario" id="formulario" onchange="manejarCambio(this)">
