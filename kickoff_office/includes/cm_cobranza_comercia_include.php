...
// ==========================================================
// 1) LISTA FIJA DE ESTADOS (tomada desde Sweet)
// ==========================================================
$LISTA_ESTADO_SWEET = [
    ["key" => "Activo", "label" => "Activo"],
    ["key" => "acuerdo_cobranza_comer", "label" => "Acuerdo cobranza comercial"],
    ["key" => "cobranza_comercial", "label" => "COBRANZA COMERCIAL"],
    ["key" => "Baja", "label" => "De baja"],
    ["key" => "baja_forzada", "label" => "De baja forzada"],
    ["key" => "esporadico", "label" => "Esporádico"],
    ["key" => "Extrajudicial", "label" => "Extrajudicial"],
    ["key" => "Prospecto", "label" => "Prospecto"],
    ["key" => "Reemplazado", "label" => "Reemplazado"],
    ["key" => "retencion_posible_baja", "label" => "RETENCION Posible Baja"],
    ...
    $contenido .= "<tr class='{$clase}'>
        ...
        <td style='text-align:left;'>
            <a target='_blank' 
               ...
               style='color:#1F1D3E; text-decoration:none;'>{$cliente}</a>
        </td>
